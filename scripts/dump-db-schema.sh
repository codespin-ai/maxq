...
# Script to dump the MaxQ database schema
...
OUTPUT_FILE="$PROJECT_ROOT/docs/maxq-schema.sql"
...
DB_HOST="${FOREMAN_DB_HOST:-localhost}"
DB_PORT="${FOREMAN_DB_PORT:-5432}"
DB_NAME="${FOREMAN_DB_NAME:-maxq}"
DB_USER="${FOREMAN_DB_USER:-postgres}"
